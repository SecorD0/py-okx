...
from py_okx.asset.models import (
...
from py_okx.models import Methods, FundingToken, AccountType, AccountTypes
...
class Asset(Base):
    ...
    def currencies(self, token_symbol: Optional[str] = None) -> Dict[str, Dict[str, Currency]]:
        """
    ...
    def balances(self, token_symbol: Optional[str] = None) -> Dict[str, FundingToken]:
        """
    ...
    def withdrawal(
        ...
        method = 'withdrawal'
        if not fee:
            currency = self.currencies(token_symbol=token_symbol)
    ...
    def cancel_withdrawal(self, wdId: Union[str, int]) -> int:
        """
        Cancel a withdrawal.
