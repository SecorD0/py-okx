...
```sh
pip install --force-reinstall git+https://github.com/SecorD0/py-okx
```
...
⠀If you found a bug or have an idea, go to [the link](https://github.com/SecorD0/py-okx/issues/new/choose), select the template, fill it out and submit it.
